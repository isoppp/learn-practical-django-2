...
class TestPage(TestCase):
    ...
    def test_products_page_returns_active(self):
        models.Product.objects.create(
            name="The cathedral and the bazaar", slug="tale-two-cities", price=Decimal("2.00"), active=False
        )
    ...
    def test_products_page_filters_by_tags_and_active(self):
        cb = models.Product.objects.create(
            name="The cathedral and the bazaar", slug="cathedral-bazzar", price=Decimal("10.00")
        )
        cb.tags.create(name="Open source", slug="opensource")
        models.Product.objects.create(
            name="Microsoft Windows guid", slug="microsoft-windows-guid", price=Decimal("12.00")
        )
    ...
    def test_user_signup_page_submission_works(self):
        post_data = {"email": "user@domain.com", "password1": "abcabcabc", "password2": "abcabcabc"}
    ...
    def test_address_list_page_returns_only_owned(self):
        ...
        models.Address.objects.create(
            user=user1, name="john kimball", address1="flat 2", address2="12 Stralz avenue", city="London", country="uk"
        )
        models.Address.objects.create(
            user=user2, name="marc kimball", address1="123 Deacon road", city="London", country="uk"
        )
    ...
    def test_add_to_basket_loggedin_works(self):
        ...
        self.client.force_login(user1)
        self.client.get(reverse("add_to_basket"), {"product_id": cb.id})
        self.client.get(reverse("add_to_basket"), {"product_id": cb.id})
        ...
        self.client.get(reverse("add_to_basket"), {"product_id": w.id})
    ...
    def test_add_to_basket_login_merge_works(self):
        ...
        self.client.get(reverse("add_to_basket"), {"product_id": w.id})
        self.client.post(reverse("login"), {"email": "user1@a.com", "password": "pw432joij"})
