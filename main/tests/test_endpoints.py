...
class TestEndpoints(APITestCase):
    def test_mobile_login_works(self):
        models.User.objects.create_user("user1", "abcabcabc")
        response = self.client.post(reverse("mobile_token"), {"username": "user1", "password": "abcabcabc"})
    ...
    def test_mobile_flow(self):
        ...
        expected = [
            {"id": orders[1].id, "image": None, "price": 28.0, "summary": "2 x The B Book"},
            {"id": orders[0].id, "image": None, "price": 24.0, "summary": "2 x The book of A"},
        ]
